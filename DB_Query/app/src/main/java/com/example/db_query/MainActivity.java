...
public class MainActivity extends Activity implements OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        btnAll = (Button) findViewById(R.id.button);
        btnAll.setOnClickListener(this);

        btnFunc = (Button) findViewById(R.id.button2);
        btnFunc.setOnClickListener(this);

        btnPeople = (Button) findViewById(R.id.button3);
        btnPeople.setOnClickListener(this);

        btnSort = (Button) findViewById(R.id.button4);
        btnSort.setOnClickListener(this);

        btnGroup = (Button) findViewById(R.id.button5);
        btnGroup.setOnClickListener(this);

        btnHaving = (Button) findViewById(R.id.button6);
        btnHaving.setOnClickListener(this);

        etFunc = (EditText) findViewById(R.id.editText);
        etPeople = (EditText) findViewById(R.id.editText2);
        etRegionPeople = (EditText) findViewById(R.id.editText3);
        rgSort = (RadioGroup) findViewById(R.id.Rgp);
        ...
        c.close();
        dbHelper.close();
        // эмуляция нажатия кнопка button (btnAll)
        onClick(btnAll);
